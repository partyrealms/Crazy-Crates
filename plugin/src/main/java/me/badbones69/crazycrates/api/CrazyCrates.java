...
public class CrazyCrates {
    ...
    public void loadCrates() {
        ...
        useNewMaterial = version.isNewer(Version.v1_17_R1);
        useNewSounds = version.isNewer(Version.v1_17_R1);
        switch (version) {
            case v1_17_R1:
        ...
        boolean isNewer = Version.getCurrentVersion().isNewer(Version.v1_17_R1);
    ...
    public boolean takeKeys(int amount, Player player, Crate crate, KeyType keyType, boolean checkHand) {
        switch (keyType) {
            case PHYSICAL_KEY:
                ...
                boolean hasOffhand = Version.getCurrentVersion().isNewer(Version.v1_17_R1);
                try {
                    List<ItemStack> items = new ArrayList<>();
                    if (checkHand) {
                        items.add(nmsSupport.getItemInMainHand(player));
